...
public class ResultVO implements Serializable {
    ...
    public static ResultVO success() {
        return new ResultVO(CodeEnum.SUCCESS.getCode(), CodeEnum.SUCCESS.getMessage(), null);
    }

    public static ResultVO success(Object data) {
        return new ResultVO(CodeEnum.SUCCESS.getCode(), CodeEnum.SUCCESS.getMessage(), data);
    }
